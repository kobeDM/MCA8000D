...
int NaI()
{
    ...
    TH1D *hist = new TH1D("hist", (analysis_dir + "   NaI;Energy [keV];Counts / keV / sec").c_str(), MCACh, 0, MCACh);
    double sum[MCACh] = {0};
    ...
    std::string out_png  = out_dir + "NaI.png";
